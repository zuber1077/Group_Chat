...
(function() {
  ...
  exports.container = function() {
    var argList, container, factories, get, getSandboxed, haveVisited, list, load, loaddir, loadfile, modules, notEmpty, register, registerOne, resolve, toFactory;
    factories = {};
    modules = {};
    ...
    getSandboxed = function(name, overrides) {
      var mockContainer;
